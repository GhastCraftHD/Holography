...
public class PageUtil {
    ...
    public static void addPageSwitchItems(ItemStack[] content, Page page){
        ...
        positionLore.add("§7of the text display");
        ...
        sizeLore.add("§7of the text display");
        ...
        rotationLore.add("§7of the text display");
        rotationMeta.setLore(rotationLore);
        rotation.setItemMeta(rotationMeta);
        content[18] = rotation;

        ItemStack attributes = new ItemStack(Material.OAK_HANGING_SIGN);
        ItemMeta attributesMeta = attributes.getItemMeta();
        attributesMeta.setDisplayName("§eAttributes");
        List<String> attributesLore = new ArrayList<>();
        attributesLore.add("§7Adjust the attributes");
        attributesLore.add("§7of the text display");
        attributesMeta.setLore(attributesLore);
        attributes.setItemMeta(attributesMeta);
        content[27] = attributes;
        ...
        switch(page){
            ...
            case ATTRIBUTES -> PageUtil.addGlint(attributes);
        }
    }
    ...
    public static void addGeneralItems(ItemStack[] content){
        ...
        deselectMeta.setDisplayName("§cDeselect Text Display");
        deselect.setItemMeta(deselectMeta);
        content[26] = deselect;

        ItemStack delete = new ItemStack(Material.BARRIER);
        ItemMeta deleteMeta = delete.getItemMeta();
        deleteMeta.setDisplayName("§cDelete Text Display");
